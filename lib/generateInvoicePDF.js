                               ...
                               <View style={[styles.table, styles.taxTable]}>
                                       ...
                                       {order.gst?.cgst > 0 && (
                                               <View style={styles.tableRow}>
                                                       ...
                                                       <View style={[styles.tableCol, styles.halfCol]}>
                                                               <Text style={styles.tableCell}>₹{order.gst.cgst.toFixed(2)}</Text>
                                                       </View>
                                               </View>
                                       )}
                                       {order.gst?.sgst > 0 && (
                                               <View style={styles.tableRow}>
                                                       ...
                                                       <View style={[styles.tableCol, styles.halfCol]}>
                                                               <Text style={styles.tableCell}>₹{order.gst.sgst.toFixed(2)}</Text>
                                                       </View>
                                               </View>
                                       )}
                                       {order.gst?.igst > 0 && (
                                               <View style={styles.tableRow}>
                                                       ...
                                                       <View style={[styles.tableCol, styles.halfCol]}>
                                                               <Text style={styles.tableCell}>₹{order.gst.igst.toFixed(2)}</Text>
                                                       </View>
                                               </View>
                                       )}
                               </View>
