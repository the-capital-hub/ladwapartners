...
export default function FeaturedBanner() {
        ...
        return (
                <motion.section
                        className="relative rounded-xl bg-white shadow-md overflow-hidden"
                ...
                >
                        <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
                                <div className="p-8 lg:p-12">
                                        <div className="text-sm font-medium text-red-600 mb-2">Featured Product</div>
                                ...
                                <div className="relative h-64 lg:h-96 cursor-pointer" onClick={handleRedirect}>
                                        <Image
                                                src={product.image}
                                                alt={product.name}
                                                width={500}
