        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-5 items-center">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <motion.h1 
                className={`${kan.className} text-4xl md:text-5xl lg:text-6xl font-bold text-[#16213E] leading-10`}
                variants={listItemVariants}
              >
                Crafting the future of the Safety
              </motion.h1>
            </div>
            ...
            <motion.p 
              ...
              variants={listItemVariants}
            >
              Introducing the Titan 4 Pcs 750mm High-Visibility Traffic Safety Cones 
              with Reflective Strips. These robust cones are perfect for ensuring safety 
              in any setting, making them essential for effective traffic management.
            </motion.p>
            ...
            >
              {[
                ...
                >
                  ...
                  <p className="text-[#16213E] text-base leading-8">{feature}</p>
                </motion.div>
              ))}
            </motion.div>
