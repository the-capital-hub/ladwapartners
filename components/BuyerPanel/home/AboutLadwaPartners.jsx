			...
			>
				...
				<div className="flex-1 flex">
					...
					<motion.div
						...
						className="relative h-full max-w-sm lg:mb-8 "
					>
						<div>
							<Image
								src={img2}
							...
							<motion.div
								...
								className="absolute bottom-20 -left-14 bg-[#FFB82D] text-black px-3 py-2 rounded-md"
							>
				...
				<motion.div
					variants={itemVariants}
					className="text-black max-w-sm flex flex-col md:p-0 mb-6 lg:mb-8"
				>
					<div>
						<p className="text-sm md:text-base lg:text-2xl leading-relaxed mb-4 md:mb-6 text-left leading-">
							Introducing the Titan 4 Pcs 750mm High-Visibility Traffic Safety
							Cones with Reflective Stripes. These robust cones are perfect for
							ensuring safety in any setting, making them essential for
