					...
					<div className="space-y-6">
						...
						>
							<div className="relative w-full h-96 lg:h-[400px]">
								<Image
									src={dummyProduct.images[selectedImage] || "https://res.cloudinary.com/drjt9guif/image/upload/v1755848946/ladwapartnersfallback_s5zjgs.png"}
						...
						<div className="flex space-x-4 justify-center overflow-x-auto">
							{dummyProduct.images.map((image, index) => (
								...
								>
									<Image
										src={image || "https://res.cloudinary.com/drjt9guif/image/upload/v1755848946/ladwapartnersfallback_s5zjgs.png"}
